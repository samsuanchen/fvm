...
//////////////////////////////////////////////////////////////////////////
// W714 btLB ( -- pin ) the Left  Blue   button
#define btLB     33
const Word W_btLB PROGMEM={LAST, 0x714, 0, "\x04" "btLB", _doCon, btLB };
#define LAST (Word*)&W_btLB
//////////////////////////////////////////////////////////////////////////
// W715 btLY ( -- pin ) the Left  Yellow button
#define btLY     27
const Word W_btLY PROGMEM={LAST, 0x715, 0, "\x04" "btLY", _doCon, btLY };
#define LAST (Word*)&W_btLY
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
const int8_t buttons[9] = { btPROG, btLG, btSTART, btLY, btLR, btLB, btRY, btRB, btSELECT };
//////////////////////////////////////////////////////////////////////////
#define LED    16
#define BEEPER 25
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W801 wb32_setAddrWindow ( x0 y0 x1 y1 -- ) set window rect
static void _wb32_setAddrWindow(){
  uint16_t y1=(uint16_t)(F.dPop()), x1=(uint16_t)(F.dPop());
  uint16_t y0=(uint16_t)(F.dPop()), x0=(uint16_t)(F.dPop());
  wb32_setAddrWindow(x0, y0, x1, y1);
}
const Word W_wb32_setAddrWindow PROGMEM={LAST, 0x801, 0, "\x12" "wb32_setAddrWindow", _wb32_setAddrWindow, (int)"_wb32_setAddrWindow" };
#define LAST (Word*)&W_wb32_setAddrWindow
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W802 wb32_fillScreen ( color -- ) fill screen by given color
static void _wb32_fillScreen(){
  uint16_t color=(uint16_t)(F.dPop());
  wb32_fillScreen(color);
}
const Word W_wb32_fillScreen PROGMEM={LAST, 0x802, 0, "\x0f" "wb32_fillScreen", _wb32_fillScreen, (int)"_wb32_fillScreen" };
#define LAST (Word*)&W_wb32_fillScreen
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W803 wb32_fillRect ( x y w h color -- ) fill rect by given color
static void _wb32_fillRect(){
  uint16_t color=(uint16_t)(F.dPop());
  int16_t h=(int16_t)(F.dPop()), w=(int16_t)(F.dPop());
  int16_t y=(int16_t)(F.dPop()), x=(int16_t)(F.dPop());
  wb32_fillRect(x, y, w, h, color);
}
const Word W_wb32_fillRect PROGMEM={LAST, 0x803, 0, "\x0d" "wb32_fillRect", _wb32_fillRect, (int)"_wb32_fillRect" };
#define LAST (Word*)&W_wb32_fillRect
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W804 wb32_drawPixel ( x y color -- ) at x,y draw pixel of given color
static void _wb32_drawPixel(){
  uint16_t color=(uint16_t)(F.dPop());
  uint16_t y=(uint16_t)(F.dPop());
  uint16_t x=(uint16_t)(F.dPop());
  wb32_drawPixel(x, y, color);
}
const Word W_wb32_drawPixel PROGMEM={LAST, 0x804, 0, "\x0e" "wb32_drawPixel", _wb32_drawPixel, (int)"_wb32_drawPixel" };
#define LAST (Word*)&W_wb32_drawPixel
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W805 wb32_pushColor ( color -- ) push given color
static void _wb32_pushColor(){
  uint16_t color=(uint16_t)(F.dPop());
  wb32_pushColor(color);
}
const Word W_wb32_pushColor PROGMEM={LAST, 0x805, 0, "\x0e" "wb32_pushColor", _wb32_pushColor, (int)"_wb32_pushColor" };
#define LAST (Word*)&W_wb32_pushColor
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W806 wb32_drawFastVLine ( x y h color -- ) draw vertical line at x,y of hight h
static void _wb32_drawFastVLine(){
  uint16_t color=(uint16_t)(F.dPop());
  int16_t h=(int16_t)(F.dPop());
  int16_t y=(int16_t)(F.dPop());
  int16_t x=(int16_t)(F.dPop());
  wb32_drawFastVLine(x, y, h, color);
}
const Word W_wb32_drawFastVLine PROGMEM={LAST, 0x806, 0, "\x12" "wb32_drawFastVLine", _wb32_drawFastVLine, (int)"_wb32_drawFastVLine" };
#define LAST (Word*)&W_wb32_drawFastVLine
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W807 wb32_drawFastHLine ( x y w color -- ) draw horizontal line at x,y of width w
static void _wb32_drawFastHLine(){
  uint16_t color=(uint16_t)(F.dPop());
  int16_t w=(int16_t)(F.dPop());
  int16_t y=(int16_t)(F.dPop());
  int16_t x=(int16_t)(F.dPop());
  wb32_drawFastHLine(x, y, w, color);
}
const Word W_wb32_drawFastHLine PROGMEM={LAST, 0x807, 0, "\x12" "wb32_drawFastHLine", _wb32_drawFastHLine, (int)"_wb32_drawFastHLine" };
#define LAST (Word*)&W_wb32_drawFastHLine
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W808 wb32_drawRect ( x y w color -- ) draw rect at x,y of width w hight h
static void _wb32_drawRect(){
  uint16_t color=(uint16_t)(F.dPop());
  int16_t h=(int16_t)(F.dPop());
  int16_t w=(int16_t)(F.dPop());
  int16_t y=(int16_t)(F.dPop());
  int16_t x=(int16_t)(F.dPop());
  wb32_drawRect(x, y, w, h, color);
}
const Word W_wb32_drawRect PROGMEM={LAST, 0x808, 0, "\x0d" "wb32_drawRect", _wb32_drawRect, (int)"_wb32_drawRect" };
#define LAST (Word*)&W_wb32_drawRect
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W809 wb32_drawLine ( x0 y0 x1 y1 color w -- ) draw color line from x0,y0 to x1,y1 of width w
static void _wb32_drawLine(){
  int16_t w=(int16_t)(F.dPop());
  uint16_t color=(uint16_t)(F.dPop());
  ...
  wb32_drawLine(x0, y0, x1, y1, color, w);
}
const Word W_wb32_drawLine PROGMEM={LAST, 0x809, 0, "\x0d" "wb32_drawLine", _wb32_drawLine, (int)"_wb32_drawLine" };
#define LAST (Word*)&W_wb32_drawLine
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W80a wb32_drawCircle ( x y r color w -- ) draw color circle at x,y of radius r width w
static void _wb32_drawCircle(){
  uint16_t w=(int16_t)(F.dPop());
  uint16_t color=(uint16_t)(F.dPop());
  int16_t r=(int16_t)(F.dPop());
  int16_t y=(int16_t)(F.dPop());
  int16_t x=(int16_t)(F.dPop());
  wb32_drawCircle(x, y, r, color, w);
}
const Word W_wb32_drawCircle PROGMEM={LAST, 0x80a, 0, "\x0f" "wb32_drawCircle", _wb32_drawCircle, (int)"_wb32_drawCircle" };
#define LAST (Word*)&W_wb32_drawCircle
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W80b wb32_drawCorner ( x y r corner color w -- ) draw color corner at x,y of radius r width w
static void _wb32_drawCorner(){
  ...
  int16_t y=(int16_t)(F.dPop());
  int16_t x=(int16_t)(F.dPop());
  wb32_drawCorner(x, y, r, corner, color, w);
}
const Word W_wb32_drawCorner PROGMEM={LAST, 0x80b, 0, "\x0f" "wb32_drawCorner", _wb32_drawCorner, (int)"_wb32_drawCorner" };
#define LAST (Word*)&W_wb32_drawCorner
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W80c wb32_fillCircle ( x y radius cornername delta color -- ) fill circle at x,y with given radius cornername delta color
static void _wb32_fillCircle(){
  uint16_t color=(uint16_t)(F.dPop());
  ...
  int16_t y=(int16_t)(F.dPop());
  int16_t x=(int16_t)(F.dPop());
  wb32_fillCircle(x, y, radius, cornername, delta, color);
}
const Word W_wb32_fillCircle PROGMEM={LAST, 0x80c, 0, "\x0f" "wb32_fillCircle", _wb32_fillCircle, (int)"_wb32_fillCircle" };
#define LAST (Word*)&W_wb32_fillCircle
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W80d wb32_fillCircle2 ( x y radius color -- ) fill circle at x,y with given radius color
static void _wb32_fillCircle2(){
  uint16_t color=(uint16_t)(F.dPop());
  int16_t r=(int16_t)(F.dPop());
  int16_t y=(int16_t)(F.dPop());
  int16_t x=(int16_t)(F.dPop());
  wb32_fillCircle2(x, y, r, color);
}
const Word W_wb32_fillCircle2 PROGMEM={LAST, 0x80d, 0, "\x10" "wb32_fillCircle2", _wb32_fillCircle2, (int)"_wb32_fillCircle2" };
#define LAST (Word*)&W_wb32_fillCircle2
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W80e wb32_drawImage ( x y w h image -- ) draw w*h image at x,y
static void _wb32_drawImage(){
  char *a=(char *)(F.dPop());
  ...
  uint16_t y=(uint16_t)(F.dPop());
  uint16_t x=(uint16_t)(F.dPop());
  wb32_drawImage(x, y, w, h, image);
}
const Word W_wb32_drawImage PROGMEM={LAST, 0x80e, 0, "\x0e" "wb32_drawImage", _wb32_drawImage, (int)"_wb32_drawImage" };
#define LAST (Word*)&W_wb32_drawImage
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W80f wb32_setTextColor ( color bgColor -- ) set color and background color for text
static void _wb32_setTextColor(){
  uint16_t bgColor=(uint16_t)(F.dPop());
  uint16_t color=(uint16_t)(F.dPop());
  wb32_setTextColor(color, bgColor);
}
const Word W_wb32_setTextColor PROGMEM={LAST, 0x80f, 0, "\x11" "wb32_setTextColor", _wb32_setTextColor, (int)"_wb32_setTextColor" };
#define LAST (Word*)&W_wb32_setTextColor
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W810 wb32_drawString ( str x y size type -- ) at x,y draw string of given size type 
static void _wb32_drawString(){
  uint8_t type=(uint8_t)(F.dPop());
  uint8_t size=(uint8_t)(F.dPop());
  uint16_t y=(uint16_t)(F.dPop());
  uint16_t x=(uint16_t)(F.dPop());
  const char *str=(const char *)(F.dPop());
  F.dPush( wb32_drawString(str, x, y, size, type) );
}
const Word W_wb32_drawString PROGMEM={LAST, 0x810, 0, "\x0f" "wb32_drawString", _wb32_drawString, (int)"_wb32_drawString" };
#define LAST (Word*)&W_wb32_drawString
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W811 wb32_drawChar ( uniCode x y size type -- w ) at x,y draw char of given uniCode size type, return width
static void _wb32_drawChar(){
  uint8_t type=(uint8_t)(F.dPop());
  uint8_t size=(uint8_t)(F.dPop());
  uint16_t y=(uint16_t)(F.dPop());
  uint16_t x=(uint16_t)(F.dPop());
  uint16_t uniCode=(uint16_t)(F.dPop());
  F.dPush( wb32_drawChar(uniCode, x, y, size, type) );
}
const Word W_wb32_drawChar PROGMEM={LAST, 0x811, 0, "\x0d" "wb32_drawChar", _wb32_drawChar, (int)"_wb32_drawChar" };
#define LAST (Word*)&W_wb32_drawChar
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W812 wb32_color565 ( r g b -- color ) get color code of given r g b
static void _wb32_color565(){
  uint8_t b=(uint8_t)(F.dPop());
  uint8_t g=(uint8_t)(F.dPop());
  uint8_t r=(uint8_t)(F.dPop());
  F.dPush( (long)wb32_color565(r, g, b) );
}
const Word W_wb32_color565 PROGMEM={LAST, 0x812, 0, "\x0d" "wb32_color565", _wb32_color565, (int)"_wb32_color565" };
#define LAST (Word*)&W_wb32_color565
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W813 wb32_init ( -- ) initialize graphics system
static bool wb32_initialized=0;
static void _wb32_init(){ if(wb32_initialized) return; wb32_initialized=1; wb32_init(); }
const Word W_wb32_init PROGMEM={LAST, 0x813, 0, "\x09" "wb32_init", _wb32_init, (int)"_wb32_init" };
#define LAST (Word*)&W_wb32_init
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W814 wb32_setPal8 ( i -- color ) set palette of i-th color
static void _wb32_setPal8(){
  uint16_t i=(uint16_t)(F.dPop());
  uint8_t color=(uint8_t)(F.dPop());
  wb32_setPal8(i, color);
}
const Word W_wb32_setPal8 PROGMEM={LAST, 0x814, 0, "\x0c" "wb32_setPal8", _wb32_setPal8, (int)"_wb32_setPal8" };
#define LAST (Word*)&W_wb32_setPal8
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W815 wb32_blit8 ( -- )
const Word W_wb32_blit8 PROGMEM={LAST, 0x815, 0, "\x0a" "wb32_blit8", wb32_blit8, (int)"wb32_blit8" };
#define LAST (Word*)&W_wb32_blit8
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W816 wb32_blit8 ( xs ys ws xd yd width height image -- )
static void _wb32_blitBuf8(){
  ...
  wb32_blitBuf8(xs, ys, ws, xd, yd, width, height, image);
}
const Word W_wb32_blitBuf8 PROGMEM={LAST, 0x816, 0, "\x0d" "wb32_blitBuf8", _wb32_blitBuf8, (int)"_wb32_blitBuf8" };
#define LAST (Word*)&W_wb32_blitBuf8
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W817 wb32_rot8 ( dx dy angle scale offx offy w h sprite -- )
static void _wb32_rot8(){
  ...
  wb32_rot8(dx, dy, angle, scale, offx, offy, w, h, sprite);
}
const Word W_wb32_rot8 PROGMEM={LAST, 0x817, 0, "\x09" "wb32_rot8", _wb32_rot8, (int)"_wb32_rot8" };
#define LAST (Word*)&W_wb32_rot8
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W818 wb32_setBuf8 ( i d -- )
static void _wb32_setBuf8(){
  uint8_t d=(uint8_t)(F.dPop());
  uint32_t i=(uint32_t)(F.dPop());
  wb32_setBuf8(i, d);
}
const Word W_wb32_setBuf8 PROGMEM={LAST, 0x818, 0, "\x0c" "wb32_setBuf8", _wb32_setBuf8, (int)"_wb32_setBuf8" };
#define LAST (Word*)&W_wb32_setBuf8
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W819 wb32_initBuf8 ( -- )
const Word W_wb32_initBuf8 PROGMEM={LAST, 0x819, 0, "\x0d" "wb32_initBuf8", wb32_initBuf8, (int)"wb32_initBuf8" };
#define LAST (Word*)&W_wb32_initBuf8
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W81a wb32_clearBuf8 ( -- )
const Word W_wb32_clearBuf8 PROGMEM={LAST, 0x81a, 0, "\x0e" "wb32_clearBuf8", wb32_clearBuf8, (int)"wb32_clearBuf8" };
#define LAST (Word*)&W_wb32_clearBuf8
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W81b wb32_tickerInit ( us code -- )
static void _wb32_tickerInit(){
  FuncP code=(FuncP)(F.dPop());
  uint32_t us=(uint32_t)(F.dPop());
  wb32_tickerInit(us, code);
}
const Word W_wb32_tickerInit PROGMEM={LAST, 0x81b, 0, "\x0f" "wb32_tickerInit", _wb32_tickerInit, (int)"_wb32_tickerInit" };
#define LAST (Word*)&W_wb32_tickerInit
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W81c wb32_tickerAlarm ( us -- )
static void _wb32_tickerAlarm(){ uint32_t us=(uint32_t)(F.dPop()); wb32_tickerAlarm(us); }
const Word W_wb32_tickerAlarm PROGMEM={LAST, 0x81c, 0, "\x10" "wb32_tickerAlarm", _wb32_tickerAlarm, (int)"_wb32_tickerAlarm" };
#define LAST (Word*)&W_wb32_tickerAlarm
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W81d wb32_tickerEnable ( -- )
const Word W_wb32_tickerEnable PROGMEM={LAST, 0x81d, 0, "\x11" "wb32_tickerEnable", wb32_tickerEnable, (int)"wb32_tickerEnable" };
#define LAST (Word*)&W_wb32_tickerEnable
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W81e wb32_tickerDisable ( -- )
const Word W_wb32_tickerDisable PROGMEM={LAST, 0x81e, 0, "\x12" "wb32_tickerDisable", wb32_tickerDisable, (int)"wb32_tickerDisable" };
#define LAST (Word*)&W_wb32_tickerDisable
/////////////////////////////////////////////////////////////////////////////////////////////////////////
// W81f wb32_drawNString ( nStr x y size type -- ) at x,y draw string of given size type 
static void _wb32_drawNString(){
  uint8_t type=(uint8_t)(F.dPop());
  uint8_t size=(uint8_t)(F.dPop());
  uint16_t y=(uint16_t)(F.dPop());
  uint16_t x=(uint16_t)(F.dPop());
  const char *nStr=(const char *)(F.dPop());
  F.dPush( wb32_drawString(nStr+1, x, y, size, type) );
}
const Word W_wb32_drawNString PROGMEM={LAST, 0x81f, 0, "\x10" "wb32_drawNString", _wb32_drawNString, (int)"_wb32_drawNString" };
#define LAST (Word*)&W_wb32_drawNString
/////////////////////////////////////////////////////////////////////////////////////////////////////////
