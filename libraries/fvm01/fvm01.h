...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
union P {                 // use a 32-bit cell to hold one of the following:
  int            con    ; // value of a constant word
  int          * var    ; // address of a variable
  int          * val    ; // address  of a value
  char         * mne    ; // name string of a primitive word
  struct Word ** wpl    ; // word list address of forth colon definition
};
/////////////////////////////////////////////////////////////////////////////////////////////////////////
union X {           // use a 32-bit cell to hold one of the following:
  float          f; // a float number
...
//----------------------------------------------------------------------------------------------------
  ...
  int        tracing    ; // trace depth of calling
...
class FVM {
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////
    void error(uint8_t id, char* format, ...);
    void errorMessage(uint8_t id, char *message);
    /////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    boolean dFull();                // check if data stack full
    /////////////////////////////////////////////////////////////////////////////////////////////////////
...
//----------------------------------------------------------------------------------------------------
  ...
  // all the following are used to compile or decompile forth words
    ...
    Word  * w_doCon, * w_doVal, * w_doVar, * w_doCol,
          ...
          * w_doBegin, * w_doAgain, * w_doUntil, * w_doWhile, * w_doRepeat, * w_compile;
